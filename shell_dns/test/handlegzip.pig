a = load '/nanke/100_01_20120712000001.gz' using PigStorage('|') as (sourceip:chararray, domainname:chararray, requestdate:chararray, destinationip:chararray, resultcode:chararray);
...
store rpt1 into '/resultg/dnstest_rpt1' using PigStorage(',');
store rpt3 into '/resultg/dnstest_rpt3' using PigStorage(',');
store rpt6 into '/resultg/dnstest_rpt6' using PigStorage(',');
store rpt4 into '/resultg/dnstest_rpt4' using PigStorage(',');
store rpt7 into '/resultg/dnstest_rpt7' using PigStorage(',');
store rpt8 into '/resultg/dnstest_rpt8' using PigStorage(',');
