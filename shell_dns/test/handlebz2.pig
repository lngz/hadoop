a = load '/nanke/100_01_20120712000001.bz2' using PigStorage('|') as (sourceip:chararray, domainname:chararray, requestdate:chararray, destinationip:chararray, resultcode:chararray);
